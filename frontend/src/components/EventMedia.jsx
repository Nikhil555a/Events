...
const EventMedia = ({ banner, setBanner, bannerPreview, setBannerPreview,onNext }) => {
  const fileInputRef = useRef(null);
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 bg-white shadow-lg rounded-lg">
      ...
      <section className="mb-8">
        ...
        <div className="border border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center justify-center bg-gray-50 h-auto">
          {bannerPreview ? (
            <img
              src={bannerPreview}
              alt="Banner Preview"
          ...
          <div className="mt-4 text-center text-[16px] text-gray-500">
            <p>
              Max image size <strong>20MB</strong>. Recommended dimension:{" "}
              <strong>1200x600px (2:1)</strong>
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-sm text-gray-500 mb-4">
          This media will appear under the gallery section.
        </p>
        <div className="border border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center justify-center bg-gray-50 h-auto">
          <button
          ...
          <div className="mt-4 text-center text-sm text-gray-500">
            <p>
              You can upload maximum <strong>10 images</strong>.
            </p>
            <p>
              Max size should be <strong>20MB</strong> per media.
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="flex justify-end pt-4">
        <button
          ...
          className="px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none "
        >
          Next
        </button>
      </div>
